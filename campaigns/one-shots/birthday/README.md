...
A complete birthday-themed D&D one-shot for three level 3 heroes, written for the 2024 fifth-edition rules. It is designed for players around age 13, a first-time Game Master, offline play, and an expected runtime of 3½–4½ hours.

The heroes must recover four strangely named components and rebuild Bellweather's forgotten celebration item. Its true purpose remains a mystery until the final reveal.

## Fastest way to play

For the simplest setup, download the [complete 49-page printable binder](pdf/The_Lost_Celebration_Age_13_DnD_One_Shot.pdf). It contains the GM adventure, read-aloud text, maps, creature statistics, player handouts, tokens, spell cards, quick rules, and all three character sheets. Nothing needs to be rebuilt or purchased from this repository.
...
- One Game Master and three players.
- Approximately 3½–4½ hours, including two scheduled breaks.
- One d20 per player, plus at least one d4, d6, d8, and d10 for the table.
...
No separate character creation is required. The three included 2024 character sheets are ready to play, and the packet includes a one-page rules reference for the players.
...
3. Print pages 27–49 single-sided for player materials; hand them out only when the GM guide calls for them.
4. If available, print pages 35–42 on cardstock and cut out the tokens, cards, and table pieces.
...
| [Lightweight binder preview](pdf/previews/The_Lost_Celebration_Age_13_DnD_One_Shot.pdf) | A smaller, screen-friendly copy of the entire 49-page binder for reviewing on GitHub. |
| [Full-quality printable binder](pdf/The_Lost_Celebration_Age_13_DnD_One_Shot.pdf) | The all-in-one, highest-quality 49-page release containing everything needed to run and play. |
...
These are smaller sections extracted from the complete binder for users who do not want to print all 49 pages.
...
| [GM keyed maps](pdf/The_Lost_Celebration_GM_Keyed_Maps.pdf) | Three maps marked with secret locations, starting positions, and encounter notes for the GM. |
...
| [Player handouts](pdf/The_Lost_Celebration_Player_Handouts.pdf) | Sixteen pages of commissions, clues, trackers, maps, cards, and rewards that can be given to players during play. |
| [Player-safe maps](pdf/The_Lost_Celebration_Maps.pdf) | Three spoiler-free zone and battle maps for Briar Farm, the Storehouse, and the Founder's Hearth. |
...
The files in [`pdf/previews/`](pdf/previews/) are lightweight, screen-friendly copies intended for GitHub viewing. Use the full-quality PDFs in [`pdf/`](pdf/) when printing. In the lightweight 49-page binder preview, only the six official character-sheet pages are flattened; the other pages retain selectable text.
